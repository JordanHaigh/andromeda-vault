...
**Original section:** [Command Line and Operations source section](<../Resources/cheat.sh/Cheat.sh Guide.md>) — [jump to section](<../Resources/cheat.sh/Cheat.sh Guide.md#programming-languages-cheat-sheets>)

## Related topics

- [[Topics/Collections/command-line-installation-and-standalone-usage|Installation And Standalone Usage]]
