...
public class WhiteBox_PreferentialElection_IsFormal_BranchDecision {
    ...
    @Test
    public void preferential_branchDecision_isFormal_candidatesDoesntContainSpecificCandidate(){
        List<String> validCandidates = new ArrayList<>();
        validCandidates.add("geoff");
        validCandidates.add("brad");
        validCandidates.add("steve");
    ...
    @Test
    public void preferential_branchDecision_isFormal_CandidateEqualsSameCandidate(){
        List<String> validCandidates = new ArrayList<>();
        validCandidates.add("geoff");
        validCandidates.add("brad");
        validCandidates.add("steve");
...
//
//    @Test
//    public void preferential_branchDecision_isFormal_FirstCombinedCondition_priorityLessThan1(){
//        List<String> validCandidates = new ArrayList<>();
//        validCandidates.add("geoff");
//        validCandidates.add("brad");
//        validCandidates.add("steve");
...
//
//    @Test
//    public void preferential_branchDecision_isFormal_FirstCombinedCondition_priorityGreaterThanCandidatesSize(){
//        List<String> validCandidates = new ArrayList<>();
//        validCandidates.add("geoff");
//        validCandidates.add("brad");
//        validCandidates.add("steve");
