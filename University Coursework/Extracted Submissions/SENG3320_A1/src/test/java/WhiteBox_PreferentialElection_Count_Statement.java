...
public class WhiteBox_PreferentialElection_Count_Statement {
    @Test
    public void preferential_count__statement_containsFormalAndInformalVotes(){
    ...
    @Test
    public void preferential_count__statement_containsNoVotes(){

        List<String> validCandidates = new ArrayList<>();

        PreferentialElection preferentialElection = new PreferentialElection(validCandidates);

        PreferentialElection.Result result = preferentialElection.count(false);
    }

    @Test
    public void preferential_count__statement_NoDominantCandidate()
    {
        List<String> validCandidates = new ArrayList<>();
        validCandidates.add("bob");
        validCandidates.add("linus");
    ...
    @Test
    public void preferential_count__statement_PerfectTie()
    {
        List<String> validCandidates = new ArrayList<>();
        validCandidates.add("bob");
        validCandidates.add("linus");
