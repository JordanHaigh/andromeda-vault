...
void Txc7::refreshDisplay() const {
    char buf[40];
...
void Txc7::finish()
{
    ...
    EV << "End to end, min:    " << endtoEndStats.getMin() << endl;
    EV << "End to end, max:    " << endtoEndStats.getMax() << endl;
    EV << "End to end, mean:   " << endtoEndStats.getMean() << endl;
    EV << "End to end, stddev: " << endtoEndStats.getStddev() << endl;
